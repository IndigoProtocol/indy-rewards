...
def get_pool_weights(
    ...
    if day >= datetime.date(2025, 11, 21):
        return {
            IAsset.from_str("ibtc"): (1200.0 / 8290.0),
            IAsset.from_str("ieth"): (250.0 / 8290.0),
            IAsset.from_str("iusd"): (6800.0 / 8290.0),
            IAsset.from_str("isol"): (40.0 / 8290.0),
        }
    if day >= datetime.date(2025, 9, 7):
        return {
            IAsset.from_str("ibtc"): (1200.0 / 6590.0),
            IAsset.from_str("ieth"): (500.0 / 6590.0),
            IAsset.from_str("iusd"): (4850.0 / 6590.0),
            IAsset.from_str("isol"): (40.0 / 6590.0),
        }
    if day >= datetime.date(2025, 7, 29):
        return {
            IAsset.from_str("ibtc"): (1800.0 / 7590.0),
            IAsset.from_str("ieth"): (500.0 / 7590.0),
            IAsset.from_str("iusd"): (5250.0 / 7590.0),
            IAsset.from_str("isol"): (40.0 / 7590.0),
        }
    if day >= datetime.date(2025, 6, 19):
        return {
            IAsset.from_str("ibtc"): (2000.0 / 9080.0),
            IAsset.from_str("ieth"): (500.0 / 9080.0),
            IAsset.from_str("iusd"): (6500.0 / 9080.0),
            IAsset.from_str("isol"): (80.0 / 9080.0),
        }
    if day >= datetime.date(2025, 5, 25):
        return {
            IAsset.from_str("ibtc"): (2000.0 / 10620.0),
            IAsset.from_str("ieth"): (500.0 / 10620.0),
            IAsset.from_str("iusd"): (8000.0 / 10620.0),
            IAsset.from_str("isol"): (120.0 / 10620.0),
        }
    if day >= datetime.date(2025, 3, 26):
        return {
            IAsset.from_str("ibtc"): (2900.0 / 15800.0),
            IAsset.from_str("ieth"): (700.0 / 15800.0),
            IAsset.from_str("iusd"): (12000.0 / 15800.0),
            IAsset.from_str("isol"): (200.0 / 15800.0),
        }
    if day >= datetime.date(2025, 1, 30):
        return {
            IAsset.from_str("ibtc"): (2884.952 / 16951.816),
            IAsset.from_str("ieth"): (941.528 / 16951.816),
            IAsset.from_str("iusd"): (12325.336 / 16951.816),
            IAsset.from_str("isol"): (800.00 / 16951.816),
        }
